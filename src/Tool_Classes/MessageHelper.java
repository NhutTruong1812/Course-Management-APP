...
public class MessageHelper {
    ...
    public static void error(Component frame, String thongBao, String linkAnh){
        ImageIcon anh = new ImageIcon(ImageHelper.anhChuan(new ImageIcon(linkAnh).getImage(), 40, 40));
        thongBao = thongBao.toUpperCase();
        JOptionPane.showMessageDialog(frame, thongBao, "BÁO LỖI", JOptionPane.PLAIN_MESSAGE, anh);
    }
